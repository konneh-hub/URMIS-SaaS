export const permissions = {
  SYSTEM_ADMIN: [
    'CREATE_INSTITUTION', 'MANAGE_SUBSCRIPTIONS', 'VIEW_PLATFORM_ANALYTICS', 'MANAGE_USERS', 'VIEW_ALL_INSTITUTIONS',
  ],
  UNIVERSITY_ADMIN: [
    'MANAGE_STUDENTS', 'MANAGE_COURSES', 'MANAGE_DEPARTMENTS', 'MANAGE_FACULTIES', 'VIEW_RESULTS',
  ],
  EXAM_OFFICER: ['VERIFY_RESULTS', 'PUBLISH_RESULTS', 'VIEW_EXAM_REPORTS'],
...
export function getUserPermissions(user) {
  ...
  const rolePermissions = [user?.role, ...(user?.assignedRoles || [])].flatMap(getRolePermissions);
