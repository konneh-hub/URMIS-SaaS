    ...
    <DashboardLayout>
      <div className="space-y-6">
        <PageHeader
          ...
          title="Communication"
          description="Message students and academic staff about your courses."
        ...
        <Card title="Message log" description="Communications sent from your teaching workspace.">
          {loading ? (
      ...
      <Dialog
        open={isOpen}
        title="Send message"
        description="Broadcast a message to your class or academic team."
