    ...
    <DashboardLayout>
      <div className="space-y-6">
        <PageHeader
          eyebrow="Alerts"
          title="Notifications"
          description="Broadcasts, alerts, and messages relevant to your teaching role."
        ...
        <div className="grid gap-4 xl:grid-cols-[0.6fr_0.4fr]">
          <Card title="Notification log" description="Messages sent to and from your teaching workspace.">
            {loading ? (
