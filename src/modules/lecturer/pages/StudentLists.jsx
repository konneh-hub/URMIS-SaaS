  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const resp = await fetch(`${API_BASE}/api/admin/students`, { headers });
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <PageHeader
          eyebrow="Class Rosters"
          title="Student Lists"
          description="View student rosters for your courses and class groups."
        ...
        <Card title="Student roster" description="Enrolled students across your assigned courses.">
          {loading ? (
            ...
            <Table
              columns={[
                ...
                { header: 'Action', accessor: 'id', render: () => <Button variant="secondary" size="sm">View</Button> },
              ]}
              rows={students}
