    ...
    <DashboardLayout>
      <div className="space-y-6">
        <PageHeader
          eyebrow="Account"
          title="Profile"
          description="Manage your personal account details and role information."
          badge={<Badge tone="info">{user?.role || 'User'}</Badge>}
        />

        <div className="max-w-3xl">
          <Card title="Account information" description="Your profile details as they appear across the platform.">
